...
exports.login = (req, res) => {
    ...
    var getUser = usersModel[setting.modelFunc](formParam[setting.dbUsername]);
                console.log('old session ' + req.session.id);
    if (getUser !== false && getUser[setting.dbPassword] === formParam[setting.formPassword]) {
