    ...
    io.on(ioDefaultEvents.connect, function(socket) {
        ...
        socket.on(roomEvents.message, function(msg) {
            ...
            var sendObj = {
                ...
                avatar: user.avatar,
                name: user.name,
                time: global.system.momentz.tz(global.system.moment.utc(), 'Asia/Ho_Chi_Minh').format('HH:mm'),
                datetime: global.system.momentz.tz(global.system.moment.utc(), 'Asia/Ho_Chi_Minh').format('DD/MM/YYYY HH:mm'),
                msg: msg.content,
